		...
		<div class="row">
			...
			<div class="wow fadeInUp col-md-12 col-sm-12" data-wow-delay="0.6s">
				<div class="section-title">
					<h2>Program Line-up</h2>
					<p>ATSEP, licensing Africa’s aviation professionals and its relevance to safety 22nd – 25th August 2017</p>
				</div>
			</div>
			...
			<div class="wow fadeInUp col-md-10 col-sm-10" data-wow-delay="0.9s">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="active"><a href="#fday" aria-controls="fday" role="tab" data-toggle="tab">21 August 2017</a></li>
					<li><a href="#sday" aria-controls="sday" role="tab" data-toggle="tab">22 August 2017</a></li>
					<li><a href="#tday" aria-controls="tday" role="tab" data-toggle="tab">23 August 2017</a></li>
				</ul>
				<!-- tab panes -->
